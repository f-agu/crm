 ...
 */
final class Version20200830132608 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE club (id INT AUTO_INCREMENT NOT NULL, uuid VARCHAR(16) NOT NULL, name VARCHAR(255) NOT NULL, logo VARCHAR(255) NOT NULL, website_url VARCHAR(512) DEFAULT NULL, facebook_url VARCHAR(512) DEFAULT NULL, mailing_list VARCHAR(512) DEFAULT NULL, active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_B8EE3872D17F50A6 (uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
